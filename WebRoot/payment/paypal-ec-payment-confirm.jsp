...
<script type="text/javascript">
	//about the paypal-token
	//var paypal_token='<%=session.getAttribute("paypal-token")%>';
	var paypal_token='<s:property value="token"  escape="false" />';
	//about the paypal-payerId
	var payerId='<s:property value="PayerID"  escape="false" />';
</script>
			...
			<div id="page" class="multiple-lan" data-widget-cid="widget-7">
				...
				<div class="process-min">
					<div class="ui-step ui-step-normal"> 
						<ol class="col4">
							<li class="first"><span class="state" style="background-position: 281px -20px;">Review your Order</span></li>
							<li class="current"><span class="state">Payment</span></li>
				...
				<div class="order-warn-tips">
					<p class="ui-notice ui-notice-normal ui-notice-prompt">
						<span class="ui-notice-body">
								Note: Please confirm your payment!
						</span>
					</p>
				</div>
				...
				<div class="payment">
					<div id="J-fastpay-submit" class="ui-fm-item ui-fm-action ">
			            <input type="submit" class="ui-button ui-button-lorange" id="J_authSubmit" value="确认付款" seed="input-confirmPay" autocomplete="off">
...
<!-- ----------------------------------------------------------------------------------- -->
<!-- ------------------------------和本网页相关--------------------------------------- -->
<script type="text/javascript" src="payment/js/paypal.payment.js"></script>
