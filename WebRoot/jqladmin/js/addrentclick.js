...
function showEditAjaxContent()
{
var obj=document.getElementById("modnavigation");
var liObj=obj.getElementsByTagName("li");
var length=liObj.length;
var currentLiObj;
for(var i=0;i<length;i++){
...
function showEditAttrValueAjaxContent()
{
var obj=document.getElementById("editnavigation");
var liObj=obj.getElementsByTagName("li");
var length=liObj.length;
var currentLiObj;
for(var i=0;i<length;i++){
