...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#FFCC33","bg_over":"#F9FCEF","bg_out":"GREEN"}
};
...
var divs = [];
divs[divs.length] = '<div id="__calendarPanel" style="z-index:101;position:absolute;display:none;background-color:#FFFFFF;border:1px solid #CCC;width:200px;height:216px;">';
...
cis[cis.length] ='select {font-size:12px;background-color:#F9FCEF;}';
cis[cis.length] ='table {border:0px solid #EEE;background-color:#FFFFFF}';
cis[cis.length] ='th {font-size:12px;font-weight:normal;background-color:#FFFFFF;}';
cis[cis.length] ='th.theader {font-weight:normal;background-color:#CCCCCC;color:#FFFFFF;width:24px;}';
...
cis[cis.length] ='td.sat {color:#0000FF;background-color:#F9FCEF;}';
cis[cis.length] ='td.sun {color:#FF0000;background-color:#F9FCEF;}';
cis[cis.length] ='td.normal {background-color:#F9FCEF;}';
cis[cis.length] ='input.l {border: 1px solid #EEEEEE;background-color:#f1f1f1;width:20px;height:20px;}';
cis[cis.length] ='input.r {border: 1px solid #EEEEEE;background-color:#f1f1f1;width:20px;height:20px;}';
cis[cis.length] ='input.b {border: 1px solid #EEEEEE;background-color:#f1f1f1;width:100%;height:20px;}';
cis[cis.length] ='-->';
