...
/**
 "pamu":
[
{"description":"","id":57,"keywords":"","lan_name":"英语","name":"bb1","productattr_id":30,"title":""},
{"description":"","id":58,"keywords":"","lan_name":"俄语","name":"bb2","productattr_id":30,"title":""}
]
 * @param data 格式如上所示
 * @returns {String}
...
function getEditHtml(data)
{
		...
		for(var i=0;i<len;i++)
		{
			...
			if(i==0)
			{//只有第一个元素才有show的class
				html+="<li class='show'><a href='javascript: void(0)' class='index'>"+temp.lan_name+"</a>"+
				"<div class='content'><table class='innertable'>";
			}
			else
			{
				html+="<li class=''><a href='javascript: void(0)' class='index'>"+temp.lan_name+"</a>"+
				"<div class='content'><table class='innertable'>";
			}
			//添加该条记录对应的主键值
