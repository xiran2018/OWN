...
<html>
	...
	<!--	
		...
		<script src="jqladmin/storemange/js/ship_country.js" type="text/javascript"></script>
						...
						<div>
				         <center>
				            ...
				            <tr class="oddrowcolor">
				                <th colspan="2" class="colume1" valign=middle align=middle>添加货运国家</th>
				            </tr>
				            <tr class="oddrowcolor">
				                <td class="colume1" valign=middle align=right>货运国家名称</td>
				                <td class="colume2">
		                   ...
		                   <tr class="evenrowcolor">
		                        <td valign=middle colspan=2 align=center>
		                            <button class="add_button" onclick="javascript:add_shipcountry()">添加 </button> 
		                        </td>
		                   </tr>   
				            </table>
