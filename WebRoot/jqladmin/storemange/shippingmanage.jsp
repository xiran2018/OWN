...
<html>
	...
	<!--	
		...
		<script src="jqladmin/storemange/js/pagination.js" type="text/javascript"></script>
		<script src="jqladmin/storemange/js/shippingmange.js" type="text/javascript"></script>
