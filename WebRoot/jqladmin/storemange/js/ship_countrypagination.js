...
function showShippingInformaton()
{
	...
	var actionUrl = "get_shippingcountry.action";	 
	var params=
	{
		"pagenum":"1"
	};
...
//	alert(dataRows);
	...
	html+="<tr><td colspan='4' style='text-align: center;'>货运国家管理</td></tr>";
	html+="<tr><td class='fourColume1'>国家名称</td><td class='fourColume2'>是否显示</td><td class='fourColume3'>备注</td><td class='fourColume4'>操作</td></tr>";
...
{
	html="";
	html+="<tr class='mui_row'><td class='fourColume1 mui_name'>"+transInfo.name+"</td><td class='fourColume2  mui_status'>"+showConvert(transInfo.status)+"</td><td class='fourColume3 mui_beizhu'>"+transInfo.beizhu+"</td><td class='fourColume4 mui_operate'>"+operate(transInfo.id)+"</td></tr>";
	return html;
}
...
function Edit(element)
{
		...
		var actionUrl="getShippingCountryById.action";
	    var params={
	            "id":idvalue
	    }; 
...
function DeleteElement(obj)
{
	if(confirm("确认删除该属性以及所有的属性值吗？"))
	{
		...
		var actionUrl="deleteShippingCountryById.action";
		var params={
				"id":idvalue
		}; 
