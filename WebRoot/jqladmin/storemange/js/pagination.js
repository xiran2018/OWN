...
function showShippingInformaton()
{
	...
	var actionUrl = "get_shipping.action";	 
	var params=
	{
		"pagenum":"1"
	};
...
//	alert(dataRows);
	...
	html+="<tr><td colspan='4' style='text-align: center;'>货运管理</td></tr>";
	html+="<tr><td class='fourColume1'>名称</td><td class='fourColume2'>是否显示</td><td class='fourColume3'>备注</td><td class='fourColume4'>操作</td></tr>";
...
function Edit(element)
{
		...
		var actionUrl="getShippingById.action";
	    var params={
	            "id":idvalue
	    }; 
...
function DeleteElement(obj)
{
	if(confirm("确认删除该属性以及所有的属性值吗？"))
	{
		...
		var actionUrl="deleteShippingById.action";
		var params={
				"id":idvalue
		}; 
