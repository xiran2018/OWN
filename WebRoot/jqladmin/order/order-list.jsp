...
<html>
	<head>
		...
		<!-- ------------------------------和本网页相关--------------------------------------- -->
		<link href="jqladmin/order/css/order-list.css" rel="stylesheet" type="text/css" />
		<!-- ------------------------------和本网页相关--------------------------------------- -->
		...
		$(function() {//日历控件
		  ...
		  var buyerName="<s:property value='buyerName' escape='false'/>";
	...
	<!-- <div class="picBox1" onclick="switchSysBar1()" id="switchPoint1"></div> -->
		...
		<!-- ------------------------------和本网页相关--------------------------------------- -->
			...
			<script type="text/javascript" src="jqladmin/order/js/order-list.js"></script>
        <!-- ------------------------------和本网页相关--------------------------------------- -->
	</body>
