							...
							<ec:table items="list"
								...
								<ec:row>
									...
									<ec:column filterable="false" sortable="false" property="图片" >
										<img style='width:70px;height:70px;' src='${img.imgsrc}'>
									...
									<ec:column property="是否使用" filterable="false" sortable="false">
									...
									<ec:column sortable="false" filterable="false" property="操作">
										<a href="categoryimage_showInfo?img.id=${img.id}">详细</a>
										<a href="categoryimage_delete?img.id=${img.id}&img.categoryid=${img.categoryid}">删除</a>
									</ec:column>
								</ec:row>
							</ec:table>
						</center>
