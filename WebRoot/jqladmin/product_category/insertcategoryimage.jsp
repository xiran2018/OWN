			...
			<div id="contentInnerWraper">
				...
				<div id="show_content_div">
					<div>
						<center>
								<p>${failMessage}</p>
								<form action="categoryimage_insert" method="post" enctype="multipart/form-data" target="_blank">
								...
								<tr>
									...
									<tr >
										<td>图片类型</td>
										<td>
											<input type="radio" name="img.type" value="0" checked="checked"/>轮播图
											<input type="radio" name="img.type" value="1" />下面小图
										</td>
									</tr>
									<tr style="display: none">
                                        <td>所属商品分类</td>
                                        <td><input type="text" name="img.categoryid" value="${categoryId}" readonly="readonly"></input></td>
                                    </tr>
