...
<link href="usermanage/css/user.point.css" rel="stylesheet" type="text/css" />
			...
			<div class="lagout-three-r">
				<div class="main-wrap">
					<div class="caption clearfix">
						<h2><s:text name="www.user.point"></s:text></h2>	
					</div>
					<div id="page960" class="main-box">
							<div class="points-summary">
								<p class="available-num"><s:text name="www.user.availablePoints"></s:text>:  
									<em>
