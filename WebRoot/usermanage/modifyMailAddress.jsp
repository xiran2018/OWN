...
<script type="text/javascript">
	editMailAddressId=<s:property value="mailAddressShowVO.mailAddress.id" escape="false"/>;
</script>

<!-- ------------------------------和本网页相关--------------------------------------- -->

<link href="usermanage/css/caption.common.css" rel="stylesheet" type="text/css" />
<link href="usermanage/css/modifyMailAddress.css" rel="stylesheet" type="text/css" />
        
<script type="text/javascript" src="usermanage/js/modifyMailAddress.js"></script>
			...
			<div class="lagout-three-r">
				<div class="main-wrap">
					<div class="caption clearfix">
						<h2><s:text name="www.user.modifyShippingAddress"></s:text></h2>	
					</div>
								...
								<div class="order-address-manage">
									<div id="address-edit-box" class="address-info-box notranslate">
										<dl class="address-info-item ui-form-item">
											...
											<input type="text" data-type="contactName" maxlength="128" class="ui-textfield ui-textfield-system" id="contact-name" name="contact-name" value='<s:property value="mailAddressShowVO.mailAddress.contactName" escape="false"/>'>
										...
										<dl class="address-info-item ui-form-item">
											...
											<dd class="ui-form-control util-clearfix">
												<select data-type="countryRegion" id="country-region-select" class="select-txt" name="_fmo.m._0.co">
												 ...
												 <script type="text/javascript">
														var countryId=<s:property value="mailAddressShowVO.mailAddress.countryId"/>;
														$("#country-region-select").find("option[value='"+countryId+"']").prop("selected","true");
												 </script>
									...
									<dl class="address-info-item ui-form-item">
										...
										<dd>
											<div class="address-info-line ui-form-control util-clearfix">
												<input type="text" class="ui-textfield ui-textfield-system" maxlength="256" id="street-address" data-type="streetAddress" name="street-address" value='<s:property value="mailAddressShowVO.mailAddress.streetAddress" escape="false"/>' placeholder="Street address">
											...
											<div class="address-info-line ui-form-control util-clearfix">
												<input type="text" class="ui-textfield ui-textfield-system" maxlength="256" id="streetAddressOther" data-type="streetAddressOther" name="streetAddressOther" value='<s:property value="mailAddressShowVO.mailAddress.streetAddressOther" escape="false"/>' placeholder="Apartment, suite, unit etc. (optional)">
											</div>
										</dd>
									</dl>
									...
									<dl class="address-info-item city-address-item ui-form-item" id="city-address-item">
										...
										<dd class="ui-form-control util-clearfix">
											<input type="text" class="ui-textfield ui-textfield-system" maxlength="64" data-type="addressCity" name="addressCity" id="addressCity" value='<s:property value="mailAddressShowVO.mailAddress.city" escape="false"/>'>
											</input>
									...
									<dl class="address-info-item ui-form-item">
										...
										<dd class="ui-form-control util-clearfix">
											<input type="text" class="ui-textfield ui-textfield-system" maxlength="9" data-type="adressPostalCode" id="adressPostalCode" name="adressPostalCode" value='<s:property value="mailAddressShowVO.mailAddress.zipCode" escape="false"/>'>
									...
									<dl class="address-info-item ui-form-item" id="telphone-info-item">
										...
										<dd class="ui-form-control util-clearfix">
											<input type="text" class="ui-textfield ui-textfield-system ui-countryNumber" data-type="numberCountry" maxlength="8" name="countryNumber" id="countryNumber" value='<s:property value="mailAddressShowVO.mailAddress.countryNumber" escape="false"/>'>
											<input type="text" class="ui-textfield ui-textfield-system ui-areaNumber" data-type="numberArea" maxlength="8" name="areaNumber"  id="areaNumber"  value='<s:property value="mailAddressShowVO.mailAddress.areaNumber" escape="false"/>'>
											<input type="text" class="ui-textfield ui-textfield-system ui-localNumber" data-type="numberPhone" maxlength="36" name="localNumber"  id="localNumber"  value='<s:property value="mailAddressShowVO.mailAddress.localNumber" escape="false"/>'>
										</dd>
										<dd>
											<p class="tips-txt">
									...
									<dl class="address-info-item ui-form-item" id="mobile-info-item">
										...
										<dd class="ui-form-control util-clearfix">
											<input type="text" class="ui-textfield ui-textfield-system" data-type="phoneNumber" id="mobile-input-ele" maxlength="16" name="mobile-input-ele" value='<s:property value="mailAddressShowVO.mailAddress.mobile" escape="false"/>'>
									...
									<div class="address-field-buttons">
										...
										<a class="ui-button ui-button-normal ui-button-medium address-btn-cancel" data-action="cancelAddress" href="javascript:;">
											<s:text name="www.shippingAddress.cancel"></s:text>
										</a>
									</div>
								</div>
							</div>
