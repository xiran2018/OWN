...
public class FilterAction 
{
	...
	public static String [] filterRedirctJSPAction={"index.action","cart.jsp","modifyMailAddress.action","addMailAddress.action","secondforegroundpage_showAll.action","productShow.action","confirmorder.action","checkout.action","showAllOrders.action","orderDetail.action","userinfo.action","changePasswordSecurity.action","buyerIndex.action","shippingAddressShow.action"};
